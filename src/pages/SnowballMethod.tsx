...
import { Zap, Plus, Trash2, Edit2, Check, X, TrendingDown, DollarSign, Calendar, Award, ArrowLeft, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 pb-20 lg:pb-8">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-6 md:py-10">
        ...
        {/* Info Banner */}
        <div className="mb-6 bg-gradient-to-r from-brand-green/10 to-emerald-50 border-2 border-brand-green/30 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-700 font-inter">
              Focus on paying off your smallest debt first while making minimum payments on others. When the smallest is paid off,
              roll that payment into the next smallest debt. This creates momentum and quick psychological wins!
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Add/Edit Debt Form */}
            {isAddingDebt && (
              <Card className="p-6 rounded-3xl shadow-lg border-2 border-brand-green/30">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border-2 border-slate-200 rounded-xl focus:border-brand-green focus:ring-2 focus:ring-brand-green/20 outline-none transition-all font-inter"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 border-2 border-slate-200 rounded-xl focus:border-brand-green focus:ring-2 focus:ring-brand-green/20 outline-none transition-all font-inter bg-white"
                    >
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-brand-green hover:bg-brand-green/90 text-white font-semibold rounded-xl"
                  >
            ...
            {/* Debts List - Sorted by Balance (Smallest First) */}
            <Card className="p-6 rounded-3xl shadow-lg">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-slate-600 font-inter">Sorted by balance (smallest first)</p>
                </div>
                <Badge className="bg-brand-green/10 text-brand-green border-0 px-3 py-1">
                  ...
                  {sortedDebts.map((debt, index) => (
                    <div
                      ...
                      className={`p-4 rounded-2xl border-2 transition-all ${
                        index === 0
                          ? 'bg-gradient-to-r from-brand-green/10 to-emerald-50 border-brand-green/30 shadow-lg'
                          : 'bg-white border-slate-200 hover:border-brand-green/20'
                      }`}
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {index === 0 && (
                              <Badge className="bg-brand-green text-white border-0 text-xs">
                      ...
                      {index === 0 && (
                        <div className="mt-3 p-3 bg-white rounded-xl border-2 border-brand-green/30">
                          <p className="text-xs font-semibold text-brand-green font-inter">
                            💡 Apply your extra ${extraPayment} payment here after paying the minimum!
                          </p>
                        </div>
                      )}
                    </div>
          ...
          <div className="space-y-6">
            {/* Extra Payment Input */}
            <Card className="p-6 rounded-3xl shadow-lg bg-gradient-to-br from-brand-green via-emerald-500 to-teal-500 text-white">
            ...
            <Card className="p-6 rounded-3xl shadow-lg">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border-2 border-purple-200 text-center">
                ...
                <p className="text-xs text-slate-600 font-inter">
                  You're on track to be debt-free in {Math.ceil(timeline.months / 12)} years!
                </p>
              </div>
            </Card>
              ...
              <div className="space-y-2">
                {sortedDebts.map((debt, index) => (
                  ...
                  >
                    ...
                    {index === 0 && <Check className="w-5 h-5 text-brand-green" />}
                  </div>
                ))}
              </div>
            </Card>
            ...
            <Link to="/avalanche-method">
              <Card className="p-4 rounded-2xl shadow-lg bg-gradient-to-r from-brand-blue/10 to-brand-blue-light/10 border-2 border-brand-blue/30 hover:border-brand-blue/50 transition-all cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-600 font-inter">
                      See which method saves you more
                    </p>
                  </div>
